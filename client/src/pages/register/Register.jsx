    ...
    <div className="register-container mt-5 mx-auto form-container">
      <form className="p-5 row g-3" onSubmit={handleSubmit}>
        <div className="col-md-12">
          ...
          <input type="text" className="form-control" id="inputUsername" value={username} onChange={handleUsernameChange} required />
        </div>
        <div className="col-md-12">
        ...
        <div className="col-12">
          <div className="form-check">
            <input className="form-check-input" type="checkbox" id="inputIsSeller" checked={isSeller} onChange={handleIsSellerChange} />
